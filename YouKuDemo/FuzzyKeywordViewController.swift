//
//  FuzzyKeywordViewController.swift
//  YouKuDemo
//
...
protocol FuzzyKeywordViewControllerDelegate: NSObjectProtocol {
    // 选择了关键词
...
class FuzzyKeywordViewController: UITableViewController {
    weak var delegate: FuzzyKeywordViewControllerDelegate!
    ...
    override func viewDidLoad() {
        ...
        self.tableView.registerClass(FuzzyKeywordCell.self, forCellReuseIdentifier: fuzzyKeywordCellIdentifier)
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier(fuzzyKeywordCellIdentifier, forIndexPath: indexPath) as! FuzzyKeywordCell
