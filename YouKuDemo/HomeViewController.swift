...
class HomeViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.registerClass(HomeSliderCell.self, forCellReuseIdentifier: sliderCellIdentifier)
        self.tableView.registerClass(HomeUnderSliderCell.self, forCellReuseIdentifier: underSliderCellIdentifier)
    ...
    func setupNavigationBar() {
        ...
        searchLabel.textColor = RGBColor(153, g: 153, b: 153)
    ...
    func topBtnClick(btn: UIButton) {
        ...
        if index == 0 {
            self.presentViewController(UINavigationController(rootViewController: HomeSearchViewController()), animated: false, completion: nil)
        }
    }
    func searchBtnClick() {
        self.presentViewController(UINavigationController(rootViewController: HomeSearchViewController()), animated: false, completion: nil)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            let cell = tableView.dequeueReusableCellWithIdentifier(sliderCellIdentifier) as! HomeSliderCell
            if jsonDic != nil {
            ...
            let cell = tableView.dequeueReusableCellWithIdentifier(underSliderCellIdentifier) as! HomeUnderSliderCell
            if jsonDic != nil {
                cell.setJson(jsonDic)
            }
            cell.selectionStyle = UITableViewCellSelectionStyle.None
