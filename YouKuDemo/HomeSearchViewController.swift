...
class HomeSearchViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, SearchHistoryCellDelegate, SearchHistoryClearCellDelegate, SearchHistoryOpenCellDelegate, FuzzyKeywordViewControllerDelegate, SearchResultViewControllerDelegate {
    ...
    var openCells = false
    var rowCount: Int!
    var fuzzyKeywordVC: FuzzyKeywordViewController!
    ...
    override func viewDidLoad() {
        ...
        //cell
        tableView.registerClass(SearchHistoryCell.self, forCellReuseIdentifier: historyCellIdentifier)
        tableView.registerClass(SearchHistoryClearCell.self, forCellReuseIdentifier: historyClearCellIdentifier)
        tableView.registerClass(SearchHistoryOpenCell.self, forCellReuseIdentifier: historyOpenCellIdentifier)
        
        
        // 添加关键词联想控制器  默认隐藏
        fuzzyKeywordVC = FuzzyKeywordViewController()
        ...
        searchResultVC = SearchResultViewController(collectionViewLayout: layout)
    ...
    func setupNavigationBar() {
        ...
        cancelBtn.setTitleColor(RGBColor(102, g: 102, b: 102), forState: UIControlState.Normal)
    ...
    func setupFootSortView() {
        ...
        sortLabel.textColor = RGBColor(153, g: 153, b: 153)
        ...
        for index in 0...9 {
            ...
            switch index {
            case 0:
                squareLabel.backgroundColor = RGBColor(255, g: 15, b: 28)
            case 1:
                squareLabel.backgroundColor = RGBColor(255, g: 128, b: 36)
            case 2:
                squareLabel.backgroundColor = RGBColor(255, g: 163, b: 41)
            default :
                squareLabel.backgroundColor = RGBColor(217, g: 217, b: 217)
            }
            ...
            hotKeyLabel.textColor = RGBColor(102, g: 102, b: 102)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        if indexPath.row == rowCount - 1 && self.historyKeys.count >= 3 { // 最后一个cell且历史搜索大于等于3个
            if self.historyKeys.count == 3 || self.openCells {
                let cell = tableView.dequeueReusableCellWithIdentifier(historyClearCellIdentifier) as! SearchHistoryClearCell
                cell.selectionStyle = UITableViewCellSelectionStyle.None
                cell.delegate = self
                return cell
            } else {
                let cell = tableView.dequeueReusableCellWithIdentifier(historyOpenCellIdentifier) as! SearchHistoryOpenCell
                cell.selectionStyle = UITableViewCellSelectionStyle.None
                cell.delegate = self
                return cell
            }
        } else {
            let cell = tableView.dequeueReusableCellWithIdentifier(historyCellIdentifier, forIndexPath: indexPath) as! SearchHistoryCell
            cell.selectionStyle = UITableViewCellSelectionStyle.None
    ...
    // MARK: - SearchHistoryOpenCellDelegate
    func openHistoryKeyCell() {
        self.openCells = true
        self.tableView.reloadData()
    }
    
    // MARK: - SearchHistoryClearCellDelegate
    ...
    // MARK: - FuzzyKeywordViewControllerDelegate
